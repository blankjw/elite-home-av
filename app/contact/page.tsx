    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-[#0A0A0A] border-b border-[#222222]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-[#D1D5DB] text-lg max-w-xl mx-auto mb-10">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 lg:gap-16">
            ...
            <div className="lg:col-span-2 space-y-8">
              <div>
                <h2 className="font-bebas text-3xl tracking-wide text-white mb-6">Contact Info</h2>
                <div className="space-y-5">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-[#A3A3A3] text-xs mt-0.5">Call or text anytime</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-[#A3A3A3] text-sm">Serving all of Southeast Texas</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-[#A3A3A3] text-sm">We respond fast. No runaround.</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="card-dark p-6">
                ...
                <div className="flex flex-wrap gap-1.5 text-xs text-[#A3A3A3]">
                  {[
              ...
              <div className="bg-[#E8521A] rounded-sm p-6 text-center">
                ...
                <p className="text-white text-sm mb-4">Call us directly. We pick up.</p>
                <a
                  href={PHONE_HREF}
