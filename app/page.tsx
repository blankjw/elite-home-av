 ...
 <section id="possibilities" className="e-section e-paper">
  <div className="e-shell">
   ...
   <div className="experience-pair">
    <Link href="/services/theater" className="experience-card"><div className="experience-photo"><EditorialImage name="cinema" alt="Private cinema with leather seating, acoustic walls and a wide screen"/></div><div className="experience-caption"><div><p className="e-kicker">Home theater</p><h3>Make a night of staying in.</h3></div><ArrowUpRight aria-hidden="true"/></div></Link>
    <Link href="/services/audio" className="experience-card"><div className="experience-photo"><EditorialImage name="outdoor" alt="Discreet garden speaker beside a sunlit terrace"/></div><div className="experience-caption"><div><p className="e-kicker">Home & outdoor audio</p><h3>Your soundtrack. Everywhere.</h3></div><ArrowUpRight aria-hidden="true"/></div></Link>
   </div>
