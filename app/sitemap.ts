...
const routes = ['', '/services', '/services/audio', '/services/theater', '/services/lighting', '/services/surveillance', '/services/automation', '/services/networking', '/gallery', '/care', '/about', '/contact'];
