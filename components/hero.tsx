...
export function Hero(){return <section className="arrival" aria-labelledby="hero-title">
 ...
 <figure className="arrival-figure"><EditorialImage name="arrival" alt="Contemporary home with warm architectural lighting beneath a blue evening sky" priority sizes="100vw"/><figcaption><a href="#possibilities">Discover what’s possible <ArrowDown size={15}/></a></figcaption></figure>
</section>}
