export const SOLUTIONS = [
  {
    ...
    seoDescription: "Enjoy clear, even home audio indoors and outside. Elite Home AV designs and supports simple music systems in Lumberton, Beaumont, and Southeast Texas.",
  ...
  },
  {
    ...
    seoDescription: "Plan a home theater around the room, seating, sound, lighting, and clean control with Elite Home AV in Lumberton, Beaumont, and Southeast Texas today.",
  ...
  },
  {
    ...
    seoDescription: "Create useful lighting scenes and straightforward control with Elite Home AV for homes and businesses in Lumberton, Beaumont, and Southeast Texas today.",
  ...
  },
  {
    ...
    seoDescription: "Plan cameras, recording, doors, and gates as one usable system for homes and businesses with Elite Home AV in Lumberton, Beaumont, and Southeast Texas.",
  ...
  },
  {
    ...
    seoDescription: "Simplify everyday routines with practical automation that stays easy to use from Elite Home AV in Lumberton, Beaumont, and Southeast Texas.",
  ...
  },
  {
    ...
    seoDescription: "Build reliable Wi-Fi, wiring, switching, and equipment racks that stay serviceable with Elite Home AV in Lumberton, Beaumont, and Southeast Texas.",
