    ...
    <>
      ...
      <section className="py-16 md:py-20 bg-[#0A0A0A]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="card-dark p-4 mb-8 flex items-start gap-3">
            <Camera className="w-5 h-5 text-[#E8521A] flex-shrink-0 mt-0.5" />
            <p className="text-gray-400 text-sm">
              <span className="text-white font-bold">To add photos:</span> Replace the placeholder boxes below with{' '}
              <code className="text-[#E8521A] bg-black/50 px-1 py-0.5 rounded text-xs">{'<Image />'}</code> components.
              Add project images to{' '}
              <code className="text-[#E8521A] bg-black/50 px-1 py-0.5 rounded text-xs">public/images/gallery/</code>{' '}
              and update the <code className="text-[#E8521A] bg-black/50 px-1 py-0.5 rounded text-xs">src</code> prop.
            </p>
          </div>
